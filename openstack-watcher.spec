...
Requires:       python-pecan >= 1.2.1
Requires:       python-prettytable >= 0.7.2
Requires:       python-ceilometerclient >= 2.9.0
Requires:       python-cinderclient >= 3.5.0
Requires:       python-glanceclient >= 2.9.1
Requires:       python-ironicclient >= 2.3.0
Requires:       python-keystoneclient >= 3.15.0
Requires:       python-monascaclient >= 1.12.0
Requires:       python-novaclient >= 10.1.0
Requires:       python-openstackclient >= 3.14.0
Requires:       python-six >= 1.11.0
Requires:       python-sqlalchemy >= 1.2.5
Requires:       python-stevedore >= 1.28.0
Requires:       python-taskflow >= 3.1.0
Requires:       python-webob >= 1.7.4
Requires:       python-wsme >= 0.9.2
